package com.cooper.httpproxy.crt;
...
public class CertUtil {
    ...
    /**
     * 从文件加载RSA私钥 openssl pkcs8 -topk8 -nocrypt -inform PEM -outform DER -in ca.crt.key -out
     * ca_private.der
     */
    ...
    public static X509Certificate genCert(String issuer, PrivateKey caPriKey, Date caNotBefore,
     ...
     /* String issuer = "C=CN, ST=CN, L=CN, O=Cooper, OU=Cooper, CN=HttpProxy";
        String subject = "C=CN, ST=CN, L=CN, O=Cooper, OU=Cooper, CN=" + host;*/
        //根据CA证书subject来动态生成目标服务器证书的issuer和subject
        String subject = issuer.substring(0,issuer.lastIndexOf("=") + 1) + hosts[0];
